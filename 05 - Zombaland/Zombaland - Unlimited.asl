...
startup {
	...
	vars.journalEntries.Add(
		new System.Text.RegularExpressions.Regex(@"\{ ""timestamp"":""(?<timestamp>.*)"", ""event"":""Undocked"", ""StationName"":""Culpeper Gateway"", ""StationType"":"".*"", ""MarketID"":\d+(, ""Taxi"":(true|false), ""Multicrew"":(true|false))? \}"));
	vars.journalEntries.Add(
		new System.Text.RegularExpressions.Regex(@"\{ ""timestamp"":""(?<timestamp>.*)"", ""event"":""FSDJump""(, ""Taxi"":(true|false), ""Multicrew"":(true|false))?, ""StarSystem"":""Zomba"", ""SystemAddress"":\d+, .*\}"));
	// Stop 1
	vars.journalEntries.Add(
		new System.Text.RegularExpressions.Regex(@"\{ ""timestamp"":""(?<timestamp>.*)"", ""event"":""SupercruiseExit""(, ""Taxi"":(true|false), ""Multicrew"":(true|false))?, ""StarSystem"":""Zomba"", ""SystemAddress"":\d+, ""Body"":""Zomba A 1 a"", ""BodyID"":\d+, .*\}"));
	vars.journalEntries.Add(
		new System.Text.RegularExpressions.Regex(@"\{ ""timestamp"":""(?<timestamp>.*)"", (""event"":""Docked"", ""StationName"":""(Vesalius Terminal|Killough Relay|Brinkmann Botanical Collection|Noel Industrial Installation|Lagos Botanical Habitat|Ele Agricultural Biosphere)"", ""StationType"":"".*""(, ""Taxi"":(true|false), ""Multicrew"":(true|false))?, ""StarSystem"":""Zomba"", .*\ |""event"":""Touchdown"", ""PlayerControlled"":true(, ""Taxi"":(true|false), ""Multicrew"":(true|false))?, .* ""NearestDestination"":""(Pippin Beacon|Brinkmann Botanical Collection|Noel Industrial Installation|Lagos Botanical Habitat|Ele Agricultural Biosphere)"" )\}"));
	vars.journalEntries.Add(
	...
	// Return
	vars.journalEntries.Add(
		new System.Text.RegularExpressions.Regex(@"\{ ""timestamp"":""(?<timestamp>.*)"", ""event"":""FSDJump""(, ""Taxi"":(true|false), ""Multicrew"":(true|false))?, ""StarSystem"":""Glooscap"", ""SystemAddress"":\d+, .*\}"));
	vars.journalEntries.Add(
		new System.Text.RegularExpressions.Regex(@"\{ ""timestamp"":""(?<timestamp>.*)"", ""event"":""SupercruiseExit""(, ""Taxi"":(true|false), ""Multicrew"":(true|false))?, ""StarSystem"":""Glooscap"", ""SystemAddress"":\d+, ""Body"":""Culpeper Gateway"", ""BodyID"":\d+, ""BodyType"":""Station"" \}"));
	vars.journalEntries.Add(
		new System.Text.RegularExpressions.Regex(@"\{ ""timestamp"":""(?<timestamp>.*)"", ""event"":""Docked"", ""StationName"":""Culpeper Gateway"", ""StationType"":"".*""(, ""Taxi"":(true|false), ""Multicrew"":(true|false))?, ""StarSystem"":""Glooscap"", .*\}"));
