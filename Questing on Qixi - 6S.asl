...
startup {
	...
	vars.journalEntries.Add(
		new System.Text.RegularExpressions.Regex(@"\{ ""timestamp"":""(?<timestamp>.*)"", ""event"":""Undocked"", ""StationName"":""(Ohm Horizons|Dezhurov Terminal|Taylor City|Solo Orbiter)"", ""StationType"":"".*"", ""MarketID"":\d+(, ""Taxi"":(true|false), ""Multicrew"":(true|false))? \}"));

	// Stop 1
	vars.journalEntries.Add(
		new System.Text.RegularExpressions.Regex(@"\{ ""timestamp"":""(?<timestamp>.*)"", ""event"":""FSDJump""(, ""Taxi"":(true|false), ""Multicrew"":(true|false))?, ""StarSystem"":""(Asterope|Atlas|Celaeno|Maia|Pleione|Sterope II|Merope)"", ""SystemAddress"":\d+, .*\}"));
	vars.journalEntries.Add(
		new System.Text.RegularExpressions.Regex(@"\{ ""timestamp"":""(?<timestamp>.*)"", ""event"":""SupercruiseExit""(, ""Taxi"":(true|false), ""Multicrew"":(true|false))?, ""StarSystem"":""(Asterope|Atlas|Celaeno|Maia|Pleione|Sterope II|Merope)"", ""SystemAddress"":\d+, ""Body"":""(Copernicus Observatory|Cyllene Orbital|Artemis Lodge|Obsidian Orbital|Stargazer|Sterope II A|Merope 2 c)"", ""BodyID"":\d+, .*\}"));
	vars.journalEntries.Add(
		new System.Text.RegularExpressions.Regex(@"\{ ""timestamp"":""(?<timestamp>.*)"", (""event"":""Docked"", ""StationName"":""(Copernicus Observatory|Cyllene Orbital|Artemis Lodge|Obsidian Orbital|Stargazer|TBB-0TJ)"", ""StationType"":"".*""(, ""Taxi"":(true|false), ""Multicrew"":(true|false))?, ""StarSystem"":""(Asterope|Atlas|Celaeno|Maia|Pleione|Sterope II|Merope)"", .*\ |""event"":""Touchdown"", ""PlayerControlled"":true(, ""Taxi"":(true|false), ""Multicrew"":(true|false))?, .*)\}"));
	vars.journalEntries.Add(
	...
	// Return
	vars.journalEntries.Add(
		new System.Text.RegularExpressions.Regex(@"\{ ""timestamp"":""(?<timestamp>.*)"", ""event"":""FSDJump""(, ""Taxi"":(true|false), ""Multicrew"":(true|false))?, ""StarSystem"":""(HIP 29312|Altair|Vega|LHS 6282)"", ""SystemAddress"":\d+, .*\}"));
	vars.journalEntries.Add(
		new System.Text.RegularExpressions.Regex(@"\{ ""timestamp"":""(?<timestamp>.*)"", ""event"":""SupercruiseExit""(, ""Taxi"":(true|false), ""Multicrew"":(true|false))?, ""StarSystem"":""(HIP 29312|Altair|Vega|LHS 6282)"", ""SystemAddress"":\d+, ""Body"":""(Ohm Horizons|Dezhurov Terminal|Taylor City|Solo Orbiter)"", ""BodyID"":\d+, ""BodyType"":""Station"" \}"));
	vars.journalEntries.Add(
		new System.Text.RegularExpressions.Regex(@"\{ ""timestamp"":""(?<timestamp>.*)"", ""event"":""Docked"", ""StationName"":""(Ohm Horizons|Dezhurov Terminal|Taylor City|Solo Orbiter)"", ""StationType"":"".*""(, ""Taxi"":(true|false), ""Multicrew"":(true|false))?, ""StarSystem"":""(HIP 29312|Altair|Vega|LHS 6282)"", .*\}"));
